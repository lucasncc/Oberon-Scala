...
case class ArrayAssignment(array: Expression, elem: Expression) extends Designator
case class RecordAssignment(record: Expression, atrib: String) extends Designator
